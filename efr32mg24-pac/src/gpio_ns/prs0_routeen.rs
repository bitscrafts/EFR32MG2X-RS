...
impl W {
    ...
    #[doc = "Bit 12 - ASYNCH12 pin enable control bit"]
    #[inline(always)]
    pub fn asynch12pen(&mut self) -> Asynch12penW<'_, Prs0RouteenSpec> {
        Asynch12penW::new(self, 12)
    }
    #[doc = "Bit 13 - ASYNCH13 pin enable control bit"]
    #[inline(always)]
    pub fn asynch13pen(&mut self) -> Asynch13penW<'_, Prs0RouteenSpec> {
        Asynch13penW::new(self, 13)
    }
    #[doc = "Bit 14 - ASYNCH14 pin enable control bit"]
    #[inline(always)]
    pub fn asynch14pen(&mut self) -> Asynch14penW<'_, Prs0RouteenSpec> {
        Asynch14penW::new(self, 14)
    }
    #[doc = "Bit 15 - ASYNCH15 pin enable control bit"]
    #[inline(always)]
    pub fn asynch15pen(&mut self) -> Asynch15penW<'_, Prs0RouteenSpec> {
