...
impl W {
    #[doc = "Bits 0:2 - Register ID"]
    #[inline(always)]
    pub fn aluin0regid(&mut self) -> Aluin0regidW<'_, Instr1cfg0Spec> {
        Aluin0regidW::new(self, 0)
    }
    #[doc = "Bit 4 - Real Zero"]
    #[inline(always)]
    pub fn aluin0realzero(&mut self) -> Aluin0realzeroW<'_, Instr1cfg0Spec> {
        Aluin0realzeroW::new(self, 4)
    }
    #[doc = "Bit 5 - Real Negate"]
    #[inline(always)]
    pub fn aluin0realnegate(&mut self) -> Aluin0realnegateW<'_, Instr1cfg0Spec> {
        Aluin0realnegateW::new(self, 5)
    }
    #[doc = "Bit 6 - Imaginary Not Zero"]
    #[inline(always)]
    pub fn aluin0imagzero(&mut self) -> Aluin0imagzeroW<'_, Instr1cfg0Spec> {
        Aluin0imagzeroW::new(self, 6)
    }
    #[doc = "Bit 7 - Imaginary Negate"]
    #[inline(always)]
    pub fn aluin0imagnegate(&mut self) -> Aluin0imagnegateW<'_, Instr1cfg0Spec> {
        Aluin0imagnegateW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Register ID"]
    #[inline(always)]
    pub fn aluin1regid(&mut self) -> Aluin1regidW<'_, Instr1cfg0Spec> {
        Aluin1regidW::new(self, 8)
    }
    #[doc = "Bit 12 - Real Zero"]
    #[inline(always)]
    pub fn aluin1realzero(&mut self) -> Aluin1realzeroW<'_, Instr1cfg0Spec> {
        Aluin1realzeroW::new(self, 12)
    }
    #[doc = "Bit 13 - Real Negate"]
    #[inline(always)]
    pub fn aluin1realnegate(&mut self) -> Aluin1realnegateW<'_, Instr1cfg0Spec> {
        Aluin1realnegateW::new(self, 13)
    }
    #[doc = "Bit 14 - Imaginary Not Zero"]
    #[inline(always)]
    pub fn aluin1imagzero(&mut self) -> Aluin1imagzeroW<'_, Instr1cfg0Spec> {
        Aluin1imagzeroW::new(self, 14)
    }
    #[doc = "Bit 15 - Imaginary Negate"]
    #[inline(always)]
    pub fn aluin1imagnegate(&mut self) -> Aluin1imagnegateW<'_, Instr1cfg0Spec> {
        Aluin1imagnegateW::new(self, 15)
    }
    #[doc = "Bits 16:18 - Register ID"]
    #[inline(always)]
    pub fn aluin2regid(&mut self) -> Aluin2regidW<'_, Instr1cfg0Spec> {
        Aluin2regidW::new(self, 16)
    }
    #[doc = "Bit 20 - Real Zero"]
    #[inline(always)]
    pub fn aluin2realzero(&mut self) -> Aluin2realzeroW<'_, Instr1cfg0Spec> {
        Aluin2realzeroW::new(self, 20)
    }
    #[doc = "Bit 21 - Real Negate"]
    #[inline(always)]
    pub fn aluin2realnegate(&mut self) -> Aluin2realnegateW<'_, Instr1cfg0Spec> {
        Aluin2realnegateW::new(self, 21)
    }
    #[doc = "Bit 22 - Imaginary Not Zero"]
    #[inline(always)]
    pub fn aluin2imagzero(&mut self) -> Aluin2imagzeroW<'_, Instr1cfg0Spec> {
        Aluin2imagzeroW::new(self, 22)
    }
    #[doc = "Bit 23 - Imaginary Negate"]
    #[inline(always)]
    pub fn aluin2imagnegate(&mut self) -> Aluin2imagnegateW<'_, Instr1cfg0Spec> {
        Aluin2imagnegateW::new(self, 23)
    }
    #[doc = "Bits 28:30 - Register ID"]
    #[inline(always)]
    pub fn aluoutregid(&mut self) -> AluoutregidW<'_, Instr1cfg0Spec> {
