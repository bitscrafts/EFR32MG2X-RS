...
impl W {
    #[doc = "Bits 0:9 - Number of Iterations"]
    #[inline(always)]
    pub fn numiters(&mut self) -> NumitersW<'_, Loop6cfgSpec> {
        NumitersW::new(self, 0)
    }
    #[doc = "Bit 12 - Increment Dimension 0"]
    #[inline(always)]
    pub fn array0incrdim0(&mut self) -> Array0incrdim0W<'_, Loop6cfgSpec> {
        Array0incrdim0W::new(self, 12)
    }
    #[doc = "Bit 13 - Increment Dimension 1"]
    #[inline(always)]
    pub fn array0incrdim1(&mut self) -> Array0incrdim1W<'_, Loop6cfgSpec> {
        Array0incrdim1W::new(self, 13)
    }
    #[doc = "Bit 14 - Increment Dimension 2"]
    #[inline(always)]
    pub fn array0incrdim2(&mut self) -> Array0incrdim2W<'_, Loop6cfgSpec> {
        Array0incrdim2W::new(self, 14)
    }
    #[doc = "Bit 16 - Increment Dimension 0"]
    #[inline(always)]
    pub fn array1incrdim0(&mut self) -> Array1incrdim0W<'_, Loop6cfgSpec> {
        Array1incrdim0W::new(self, 16)
    }
    #[doc = "Bit 17 - Increment Dimension 1"]
    #[inline(always)]
    pub fn array1incrdim1(&mut self) -> Array1incrdim1W<'_, Loop6cfgSpec> {
        Array1incrdim1W::new(self, 17)
    }
    #[doc = "Bit 18 - Increment Dimension 2"]
    #[inline(always)]
    pub fn array1incrdim2(&mut self) -> Array1incrdim2W<'_, Loop6cfgSpec> {
        Array1incrdim2W::new(self, 18)
    }
    #[doc = "Bit 20 - Increment Dimension 0"]
    #[inline(always)]
    pub fn array2incrdim0(&mut self) -> Array2incrdim0W<'_, Loop6cfgSpec> {
        Array2incrdim0W::new(self, 20)
    }
    #[doc = "Bit 21 - Increment Dimension 1"]
    #[inline(always)]
    pub fn array2incrdim1(&mut self) -> Array2incrdim1W<'_, Loop6cfgSpec> {
        Array2incrdim1W::new(self, 21)
    }
    #[doc = "Bit 22 - Increment Dimension 2"]
    #[inline(always)]
    pub fn array2incrdim2(&mut self) -> Array2incrdim2W<'_, Loop6cfgSpec> {
        Array2incrdim2W::new(self, 22)
    }
    #[doc = "Bit 24 - Increment Dimension 0"]
    #[inline(always)]
    pub fn array3incrdim0(&mut self) -> Array3incrdim0W<'_, Loop6cfgSpec> {
        Array3incrdim0W::new(self, 24)
    }
    #[doc = "Bit 25 - Increment Dimension 1"]
    #[inline(always)]
    pub fn array3incrdim1(&mut self) -> Array3incrdim1W<'_, Loop6cfgSpec> {
        Array3incrdim1W::new(self, 25)
    }
    #[doc = "Bit 26 - Increment Dimension 2"]
    #[inline(always)]
    pub fn array3incrdim2(&mut self) -> Array3incrdim2W<'_, Loop6cfgSpec> {
        Array3incrdim2W::new(self, 26)
    }
    #[doc = "Bit 28 - Increment Dimension 0"]
    #[inline(always)]
    pub fn array4incrdim0(&mut self) -> Array4incrdim0W<'_, Loop6cfgSpec> {
        Array4incrdim0W::new(self, 28)
    }
    #[doc = "Bit 29 - Increment Dimension 1"]
    #[inline(always)]
    pub fn array4incrdim1(&mut self) -> Array4incrdim1W<'_, Loop6cfgSpec> {
        Array4incrdim1W::new(self, 29)
    }
    #[doc = "Bit 30 - Increment Dimension 2"]
    #[inline(always)]
    pub fn array4incrdim2(&mut self) -> Array4incrdim2W<'_, Loop6cfgSpec> {
