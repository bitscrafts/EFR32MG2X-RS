...
impl W {
    #[doc = "Bits 0:9 - Array Dimension Size"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Array1dim0cfgSpec> {
        SizeW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Element Type"]
    #[inline(always)]
    pub fn basetype(&mut self) -> BasetypeW<'_, Array1dim0cfgSpec> {
        BasetypeW::new(self, 12)
    }
    #[doc = "Bit 14 - Complex Data Type"]
    #[inline(always)]
    pub fn complex(&mut self) -> ComplexW<'_, Array1dim0cfgSpec> {
        ComplexW::new(self, 14)
    }
    #[doc = "Bits 16:27 - Dimension Stride Step"]
    #[inline(always)]
    pub fn stride(&mut self) -> StrideW<'_, Array1dim0cfgSpec> {
        StrideW::new(self, 16)
    }
}
