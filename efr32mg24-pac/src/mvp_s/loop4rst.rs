...
impl W {
    #[doc = "Bit 12 - Reset Dimension 0"]
    #[inline(always)]
    pub fn array0resetdim0(&mut self) -> Array0resetdim0W<'_, Loop4rstSpec> {
        Array0resetdim0W::new(self, 12)
    }
    #[doc = "Bit 13 - Reset Dimension 1"]
    #[inline(always)]
    pub fn array0resetdim1(&mut self) -> Array0resetdim1W<'_, Loop4rstSpec> {
        Array0resetdim1W::new(self, 13)
    }
    #[doc = "Bit 14 - Reset Dimension 2"]
    #[inline(always)]
    pub fn array0resetdim2(&mut self) -> Array0resetdim2W<'_, Loop4rstSpec> {
        Array0resetdim2W::new(self, 14)
    }
    #[doc = "Bit 16 - Reset Dimension 0"]
    #[inline(always)]
    pub fn array1resetdim0(&mut self) -> Array1resetdim0W<'_, Loop4rstSpec> {
        Array1resetdim0W::new(self, 16)
    }
    #[doc = "Bit 17 - Reset Dimension 1"]
    #[inline(always)]
    pub fn array1resetdim1(&mut self) -> Array1resetdim1W<'_, Loop4rstSpec> {
        Array1resetdim1W::new(self, 17)
    }
    #[doc = "Bit 18 - Reset Dimension 2"]
    #[inline(always)]
    pub fn array1resetdim2(&mut self) -> Array1resetdim2W<'_, Loop4rstSpec> {
        Array1resetdim2W::new(self, 18)
    }
    #[doc = "Bit 20 - Reset Dimension 0"]
    #[inline(always)]
    pub fn array2resetdim0(&mut self) -> Array2resetdim0W<'_, Loop4rstSpec> {
        Array2resetdim0W::new(self, 20)
    }
    #[doc = "Bit 21 - Reset Dimension 1"]
    #[inline(always)]
    pub fn array2resetdim1(&mut self) -> Array2resetdim1W<'_, Loop4rstSpec> {
        Array2resetdim1W::new(self, 21)
    }
    #[doc = "Bit 22 - Reset Dimension 2"]
    #[inline(always)]
    pub fn array2resetdim2(&mut self) -> Array2resetdim2W<'_, Loop4rstSpec> {
        Array2resetdim2W::new(self, 22)
    }
    #[doc = "Bit 24 - Reset Dimension 0"]
    #[inline(always)]
    pub fn array3resetdim0(&mut self) -> Array3resetdim0W<'_, Loop4rstSpec> {
        Array3resetdim0W::new(self, 24)
    }
    #[doc = "Bit 25 - Reset Dimension 1"]
    #[inline(always)]
    pub fn array3resetdim1(&mut self) -> Array3resetdim1W<'_, Loop4rstSpec> {
        Array3resetdim1W::new(self, 25)
    }
    #[doc = "Bit 26 - Reset Dimension 2"]
    #[inline(always)]
    pub fn array3resetdim2(&mut self) -> Array3resetdim2W<'_, Loop4rstSpec> {
        Array3resetdim2W::new(self, 26)
    }
    #[doc = "Bit 28 - Reset Dimension 0"]
    #[inline(always)]
    pub fn array4resetdim0(&mut self) -> Array4resetdim0W<'_, Loop4rstSpec> {
        Array4resetdim0W::new(self, 28)
    }
    #[doc = "Bit 29 - Reset Dimension 1"]
    #[inline(always)]
    pub fn array4resetdim1(&mut self) -> Array4resetdim1W<'_, Loop4rstSpec> {
        Array4resetdim1W::new(self, 29)
    }
    #[doc = "Bit 30 - Reset Dimension 2"]
    #[inline(always)]
    pub fn array4resetdim2(&mut self) -> Array4resetdim2W<'_, Loop4rstSpec> {
