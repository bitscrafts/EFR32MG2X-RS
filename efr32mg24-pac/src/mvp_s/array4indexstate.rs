...
impl W {
    #[doc = "Bits 0:9 - Current Index"]
    #[inline(always)]
    pub fn dim0index(&mut self) -> Dim0indexW<'_, Array4indexstateSpec> {
        Dim0indexW::new(self, 0)
    }
    #[doc = "Bits 10:19 - Current Index"]
    #[inline(always)]
    pub fn dim1index(&mut self) -> Dim1indexW<'_, Array4indexstateSpec> {
        Dim1indexW::new(self, 10)
    }
    #[doc = "Bits 20:29 - Current Index"]
    #[inline(always)]
    pub fn dim2index(&mut self) -> Dim2indexW<'_, Array4indexstateSpec> {
