...
impl W {
    #[doc = "Bit 0 - Loop Begin"]
    #[inline(always)]
    pub fn loop0begin(&mut self) -> Loop0beginW<'_, Instr1cfg2Spec> {
        Loop0beginW::new(self, 0)
    }
    #[doc = "Bit 1 - Loop End"]
    #[inline(always)]
    pub fn loop0end(&mut self) -> Loop0endW<'_, Instr1cfg2Spec> {
        Loop0endW::new(self, 1)
    }
    #[doc = "Bit 2 - Loop Begin"]
    #[inline(always)]
    pub fn loop1begin(&mut self) -> Loop1beginW<'_, Instr1cfg2Spec> {
        Loop1beginW::new(self, 2)
    }
    #[doc = "Bit 3 - Loop End"]
    #[inline(always)]
    pub fn loop1end(&mut self) -> Loop1endW<'_, Instr1cfg2Spec> {
        Loop1endW::new(self, 3)
    }
    #[doc = "Bit 4 - Loop Begin"]
    #[inline(always)]
    pub fn loop2begin(&mut self) -> Loop2beginW<'_, Instr1cfg2Spec> {
        Loop2beginW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop End"]
    #[inline(always)]
    pub fn loop2end(&mut self) -> Loop2endW<'_, Instr1cfg2Spec> {
        Loop2endW::new(self, 5)
    }
    #[doc = "Bit 6 - Loop Begin"]
    #[inline(always)]
    pub fn loop3begin(&mut self) -> Loop3beginW<'_, Instr1cfg2Spec> {
        Loop3beginW::new(self, 6)
    }
    #[doc = "Bit 7 - Loop End"]
    #[inline(always)]
    pub fn loop3end(&mut self) -> Loop3endW<'_, Instr1cfg2Spec> {
        Loop3endW::new(self, 7)
    }
    #[doc = "Bit 8 - Loop Begin"]
    #[inline(always)]
    pub fn loop4begin(&mut self) -> Loop4beginW<'_, Instr1cfg2Spec> {
        Loop4beginW::new(self, 8)
    }
    #[doc = "Bit 9 - Loop End"]
    #[inline(always)]
    pub fn loop4end(&mut self) -> Loop4endW<'_, Instr1cfg2Spec> {
        Loop4endW::new(self, 9)
    }
    #[doc = "Bit 10 - Loop Begin"]
    #[inline(always)]
    pub fn loop5begin(&mut self) -> Loop5beginW<'_, Instr1cfg2Spec> {
        Loop5beginW::new(self, 10)
    }
    #[doc = "Bit 11 - Loop End"]
    #[inline(always)]
    pub fn loop5end(&mut self) -> Loop5endW<'_, Instr1cfg2Spec> {
        Loop5endW::new(self, 11)
    }
    #[doc = "Bit 12 - Loop Begin"]
    #[inline(always)]
    pub fn loop6begin(&mut self) -> Loop6beginW<'_, Instr1cfg2Spec> {
        Loop6beginW::new(self, 12)
    }
    #[doc = "Bit 13 - Loop End"]
    #[inline(always)]
    pub fn loop6end(&mut self) -> Loop6endW<'_, Instr1cfg2Spec> {
        Loop6endW::new(self, 13)
    }
    #[doc = "Bit 14 - Loop Begin"]
    #[inline(always)]
    pub fn loop7begin(&mut self) -> Loop7beginW<'_, Instr1cfg2Spec> {
        Loop7beginW::new(self, 14)
    }
    #[doc = "Bit 15 - Loop End"]
    #[inline(always)]
    pub fn loop7end(&mut self) -> Loop7endW<'_, Instr1cfg2Spec> {
        Loop7endW::new(self, 15)
    }
    #[doc = "Bits 20:28 - ALU opcode"]
    #[inline(always)]
    pub fn aluop(&mut self) -> AluopW<'_, Instr1cfg2Spec> {
        AluopW::new(self, 20)
    }
    #[doc = "Bit 31 - End of Program"]
    #[inline(always)]
    pub fn endprog(&mut self) -> EndprogW<'_, Instr1cfg2Spec> {
