...
impl W {
    #[doc = "Bits 0:2 - Register ID"]
    #[inline(always)]
    pub fn istream0regid(&mut self) -> Istream0regidW<'_, Instr1cfg1Spec> {
        Istream0regidW::new(self, 0)
    }
    #[doc = "Bit 3 - Load register"]
    #[inline(always)]
    pub fn istream0load(&mut self) -> Istream0loadW<'_, Instr1cfg1Spec> {
        Istream0loadW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Array ID"]
    #[inline(always)]
    pub fn istream0arrayid(&mut self) -> Istream0arrayidW<'_, Instr1cfg1Spec> {
        Istream0arrayidW::new(self, 4)
    }
    #[doc = "Bit 7 - Increment Array Dimension 0"]
    #[inline(always)]
    pub fn istream0arrayincrdim0(&mut self) -> Istream0arrayincrdim0W<'_, Instr1cfg1Spec> {
        Istream0arrayincrdim0W::new(self, 7)
    }
    #[doc = "Bit 8 - Increment Array Dimension 1"]
    #[inline(always)]
    pub fn istream0arrayincrdim1(&mut self) -> Istream0arrayincrdim1W<'_, Instr1cfg1Spec> {
        Istream0arrayincrdim1W::new(self, 8)
    }
    #[doc = "Bit 9 - Increment Array Dimension 2"]
    #[inline(always)]
    pub fn istream0arrayincrdim2(&mut self) -> Istream0arrayincrdim2W<'_, Instr1cfg1Spec> {
        Istream0arrayincrdim2W::new(self, 9)
    }
    #[doc = "Bits 10:12 - Register ID"]
    #[inline(always)]
    pub fn istream1regid(&mut self) -> Istream1regidW<'_, Instr1cfg1Spec> {
        Istream1regidW::new(self, 10)
    }
    #[doc = "Bit 13 - Load register"]
    #[inline(always)]
    pub fn istream1load(&mut self) -> Istream1loadW<'_, Instr1cfg1Spec> {
        Istream1loadW::new(self, 13)
    }
    #[doc = "Bits 14:16 - Array ID"]
    #[inline(always)]
    pub fn istream1arrayid(&mut self) -> Istream1arrayidW<'_, Instr1cfg1Spec> {
        Istream1arrayidW::new(self, 14)
    }
    #[doc = "Bit 17 - Increment Array Dimension 0"]
    #[inline(always)]
    pub fn istream1arrayincrdim0(&mut self) -> Istream1arrayincrdim0W<'_, Instr1cfg1Spec> {
        Istream1arrayincrdim0W::new(self, 17)
    }
    #[doc = "Bit 18 - Increment Array Dimension 1"]
    #[inline(always)]
    pub fn istream1arrayincrdim1(&mut self) -> Istream1arrayincrdim1W<'_, Instr1cfg1Spec> {
        Istream1arrayincrdim1W::new(self, 18)
    }
    #[doc = "Bit 19 - Increment Array Dimension 2"]
    #[inline(always)]
    pub fn istream1arrayincrdim2(&mut self) -> Istream1arrayincrdim2W<'_, Instr1cfg1Spec> {
        Istream1arrayincrdim2W::new(self, 19)
    }
    #[doc = "Bits 20:22 - Register ID"]
    #[inline(always)]
    pub fn ostreamregid(&mut self) -> OstreamregidW<'_, Instr1cfg1Spec> {
        OstreamregidW::new(self, 20)
    }
    #[doc = "Bit 23 - Store to Register"]
    #[inline(always)]
    pub fn ostreamstore(&mut self) -> OstreamstoreW<'_, Instr1cfg1Spec> {
        OstreamstoreW::new(self, 23)
    }
    #[doc = "Bits 24:26 - Array ID"]
    #[inline(always)]
    pub fn ostreamarrayid(&mut self) -> OstreamarrayidW<'_, Instr1cfg1Spec> {
        OstreamarrayidW::new(self, 24)
    }
    #[doc = "Bit 27 - Increment Array Dimension 0"]
    #[inline(always)]
    pub fn ostreamarrayincrdim0(&mut self) -> Ostreamarrayincrdim0W<'_, Instr1cfg1Spec> {
        Ostreamarrayincrdim0W::new(self, 27)
    }
    #[doc = "Bit 28 - Increment Array Dimension 1"]
    #[inline(always)]
    pub fn ostreamarrayincrdim1(&mut self) -> Ostreamarrayincrdim1W<'_, Instr1cfg1Spec> {
        Ostreamarrayincrdim1W::new(self, 28)
    }
    #[doc = "Bit 29 - Increment Array Dimension 2"]
    #[inline(always)]
    pub fn ostreamarrayincrdim2(&mut self) -> Ostreamarrayincrdim2W<'_, Instr1cfg1Spec> {
