...
impl W {
    ...
    #[doc = "Bit 28 - DCDC Privileged Access"]
    #[inline(always)]
    pub fn dcdc(&mut self) -> DcdcW<'_, Ppupatd0Spec> {
        DcdcW::new(self, 28)
    }
    #[doc = "Bit 29 - HOSTMAILBOX Privileged Access"]
    #[inline(always)]
    pub fn hostmailbox(&mut self) -> HostmailboxW<'_, Ppupatd0Spec> {
        HostmailboxW::new(self, 29)
    }
    #[doc = "Bit 30 - EUSART1 Privileged Access"]
    #[inline(always)]
    pub fn eusart1(&mut self) -> Eusart1W<'_, Ppupatd0Spec> {
        Eusart1W::new(self, 30)
    }
    #[doc = "Bit 31 - SYSRTC Privileged Access"]
    #[inline(always)]
    pub fn sysrtc(&mut self) -> SysrtcW<'_, Ppupatd0Spec> {
        SysrtcW::new(self, 31)
    }
}
