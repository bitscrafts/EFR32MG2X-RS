...
impl W {
    ...
    #[doc = "Bit 3 - MVPAHBDATA0 privileged mode"]
    #[inline(always)]
    pub fn mvpahbdata0(&mut self) -> Mvpahbdata0W<'_, Bmpupatd0Spec> {
        Mvpahbdata0W::new(self, 3)
    }
    #[doc = "Bit 4 - MVPAHBDATA1 privileged mode"]
    #[inline(always)]
    pub fn mvpahbdata1(&mut self) -> Mvpahbdata1W<'_, Bmpupatd0Spec> {
        Mvpahbdata1W::new(self, 4)
    }
    #[doc = "Bit 5 - MVPAHBDATA2 privileged mode"]
    #[inline(always)]
    pub fn mvpahbdata2(&mut self) -> Mvpahbdata2W<'_, Bmpupatd0Spec> {
