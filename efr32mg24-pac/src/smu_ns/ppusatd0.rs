...
impl W {
    ...
    #[doc = "Bit 28 - DCDC Secure Access"]
    #[inline(always)]
    pub fn dcdc(&mut self) -> DcdcW<'_, Ppusatd0Spec> {
        DcdcW::new(self, 28)
    }
    #[doc = "Bit 29 - HOSTMAILBOX Secure Access"]
    #[inline(always)]
    pub fn hostmailbox(&mut self) -> HostmailboxW<'_, Ppusatd0Spec> {
        HostmailboxW::new(self, 29)
    }
    #[doc = "Bit 30 - EUSART1 Secure Access"]
    #[inline(always)]
    pub fn eusart1(&mut self) -> Eusart1W<'_, Ppusatd0Spec> {
        Eusart1W::new(self, 30)
    }
    #[doc = "Bit 31 - SYSRTC Secure Access"]
    #[inline(always)]
    pub fn sysrtc(&mut self) -> SysrtcW<'_, Ppusatd0Spec> {
        SysrtcW::new(self, 31)
    }
}
