...
impl W {
    #[doc = "Bit 0 - SCRATCHPAD Privileged Access"]
    #[inline(always)]
    pub fn scratchpad(&mut self) -> ScratchpadW<'_, Ppunspatd0Spec> {
    ...
    #[doc = "Bit 28 - DCDC Privileged Access"]
    #[inline(always)]
    pub fn dcdc(&mut self) -> DcdcW<'_, Ppunspatd0Spec> {
        DcdcW::new(self, 28)
    }
    #[doc = "Bit 29 - HOSTMAILBOX Privileged Access"]
    #[inline(always)]
    pub fn hostmailbox(&mut self) -> HostmailboxW<'_, Ppunspatd0Spec> {
        HostmailboxW::new(self, 29)
    }
    #[doc = "Bit 30 - EUSART1 Privileged Access"]
    #[inline(always)]
    pub fn eusart1(&mut self) -> Eusart1W<'_, Ppunspatd0Spec> {
        Eusart1W::new(self, 30)
    }
    #[doc = "Bit 31 - SYSRTC Privileged Access"]
    #[inline(always)]
    pub fn sysrtc(&mut self) -> SysrtcW<'_, Ppunspatd0Spec> {
        SysrtcW::new(self, 31)
    }
}
