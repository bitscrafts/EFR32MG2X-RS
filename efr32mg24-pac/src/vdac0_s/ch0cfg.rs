...
impl W {
    #[doc = "Bit 0 - Channel 0 Conversion Mode"]
    #[inline(always)]
    pub fn convmode(&mut self) -> ConvmodeW<'_, Ch0cfgSpec> {
        ConvmodeW::new(self, 0)
    }
    #[doc = "Bit 2 - Channel 0 Power Mode"]
    #[inline(always)]
    pub fn powermode(&mut self) -> PowermodeW<'_, Ch0cfgSpec> {
        PowermodeW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Channel 0 Trigger Mode"]
    #[inline(always)]
    pub fn trigmode(&mut self) -> TrigmodeW<'_, Ch0cfgSpec> {
        TrigmodeW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Channel 0 Refresh Source"]
    #[inline(always)]
    pub fn refreshsource(&mut self) -> RefreshsourceW<'_, Ch0cfgSpec> {
        RefreshsourceW::new(self, 8)
    }
    #[doc = "Bits 11:12 - Channel 0 FIFO Low Watermark"]
    #[inline(always)]
    pub fn fifodvl(&mut self) -> FifodvlW<'_, Ch0cfgSpec> {
        FifodvlW::new(self, 11)
    }
    #[doc = "Bit 14 - Channel 0 High Cap Load Mode Enable"]
    #[inline(always)]
    pub fn highcaploaden(&mut self) -> HighcaploadenW<'_, Ch0cfgSpec> {
        HighcaploadenW::new(self, 14)
    }
    #[doc = "Bit 16 - Channel 0 Keepwarm Mode Enable"]
    #[inline(always)]
    pub fn keepwarm(&mut self) -> KeepwarmW<'_, Ch0cfgSpec> {
