...
impl R {
    ...
    #[doc = "Bit 8 - RAC active"]
    #[inline(always)]
    pub fn racactive(&self) -> RacactiveR {
        RacactiveR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - EM4 IO retention status"]
    #[inline(always)]
    pub fn em4ioret(&self) -> Em4ioretR {
        Em4ioretR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - EM2 entered"]
    #[inline(always)]
    pub fn em2entered(&self) -> Em2enteredR {
        Em2enteredR::new(((self.bits >> 10) & 1) != 0)
    }
}
