...
impl W {
    ...
    #[doc = "Bit 2 - AHB2 1-bit ECC Error Interrupt Enable"]
    #[inline(always)]
    pub fn ahb2err1b(&mut self) -> Ahb2err1bW<'_, IenSpec> {
        Ahb2err1bW::new(self, 2)
    }
    #[doc = "Bit 3 - AHB3 1-bit ECC Error Interrupt Enable"]
    #[inline(always)]
    pub fn ahb3err1b(&mut self) -> Ahb3err1bW<'_, IenSpec> {
    ...
    #[doc = "Bit 6 - AHB2 2-bit ECC Error Interrupt Enable"]
    #[inline(always)]
    pub fn ahb2err2b(&mut self) -> Ahb2err2bW<'_, IenSpec> {
        Ahb2err2bW::new(self, 6)
    }
    #[doc = "Bit 7 - AHB3 2-bit ECC Error Interrupt Enable"]
    #[inline(always)]
    pub fn ahb3err2b(&mut self) -> Ahb3err2bW<'_, IenSpec> {
